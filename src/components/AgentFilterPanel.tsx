    ...
    <div className="space-y-4">
        ...
        {tabs.map(tab => (
          ...
          >
            ...
            <span className={`text-xs px-1.5 py-0.5 rounded-full ${
              filter === tab.id ? 'bg-white/[0.1]' : 'bg-white/[0.05]'
            }`}>
              {counts[tab.id]}
            </span>
          </button>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-white/[0.03] border border-white/[0.06] rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-white/[0.15] focus:bg-white/[0.05] transition-colors"
        />
      </div>
