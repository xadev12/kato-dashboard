  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-semibold text-white">Completed Projects Archive</h2>
...
const CompletedProjectCard = memo(function CompletedProjectCard({ project }: { project: CompletedProject }) {
  return (
    <div className="group relative overflow-hidden rounded-xl border border-white/[0.06] bg-[#111111] p-5 transition-all duration-300 hover:border-white/[0.1] hover:shadow-lg">
      {/* Completed badge */}
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4 text-xs">
        <span className="px-2 py-1 rounded-md bg-white/[0.03] text-gray-400 border border-white/[0.06]">
